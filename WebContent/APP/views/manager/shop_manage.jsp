...
<div class="tabbable">
  <ul class="nav nav-tabs">
    <li class="active" id="shop_basic_tag">
       <a href="#shop_basic" data-toggle="tab" > Basic </a>
    </li>
    <li id="shop_sales_tag">
  ...
  <div class="tab-content">
     <div id="shop_basic" class="tab-pane active">
         <jsp:include page="shop_list.jsp" flush="true"/>
     </div>
     <div id="shop_sales" class="tab-pane">
         <jsp:include page="shop_sales.jsp" flush="true"/>
     </div>
